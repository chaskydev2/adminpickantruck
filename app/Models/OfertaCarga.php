...
class OfertaCarga extends Model
{
    ...
    /**
     * Verifica si la oferta fue "eliminada" por el usuario
     * (marcada con expired_notification_sent_at = '2000-01-01')
     */
    public function isDeleted(): bool
    {
        if (!$this->expired_notification_sent_at) {
            return false;
        }
        
        return $this->expired_notification_sent_at->eq(\Carbon\Carbon::parse('2000-01-01 00:00:00'));
    }
}
